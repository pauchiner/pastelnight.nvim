...
<dict>
	<key>author</key>
	<string>Pau García Chiner (http://github.com/pauchiner)</string>
	<key>colorSpaceName</key>
	<string>sRGB</string>
	<key>name</key>
	<string>PastelNight</string>
	...
	<array>
		<dict>
			...
			<dict>
				<key>activeGuide</key>
				<string>${base400}</string>
				<key>background</key>
				<string>${bg}</string>
				<key>caret</key>
				<string>${yellow300}</string>
				...
				<string>${fg}</string>
				<key>guide</key>
				<string>${base300}40</string>
				<key>gutterForeground</key>
				<string>${base400}aa</string>
				<key>inactiveSelection</key>
				<string>${base600}</string>
				<key>invisibles</key>
				<string>${base300}</string>
				<key>lineHighlight</key>
				<string>${black}30</string>
				<key>selection</key>
				<string>${pink400}40</string>
				<key>selectionBorder</key>
				<string>${pink400}</string>
				<key>shadow</key>
				<string>${black}10</string>
				<key>stackGuide</key>
				<string>${base300}60</string>
				<key>tagsOptions</key>
